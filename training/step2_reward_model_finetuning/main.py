...
from dschat.utils.module.lora import unfuse_lora, fuse_lora
from dataclasses import dataclass 
from transformers import DataCollatorWithPadding

@dataclass
class PairWiseDataCollator(DataCollatorWithPadding):
    ...
    def __call__(self, features):
        ...
        for feat in features:
            ret.append({
                "input_ids": feat[0],
                "attention_mask": feat[1],
            })
        for feat in features:
            ret.append({
                "input_ids": feat[2],
                "attention_mask": feat[3],
            })
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        if args.output_dir is not None:
            ...
            rm_model = fuse_lora(rm_model)

            if args.global_rank == 0:
                save_hf_format(rm_model, tokenizer, args, f"epoch-{epoch}")
