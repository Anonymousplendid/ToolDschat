...
ACTOR_MODEL_PATH=/tmp/home/sist/teslazhu20/model/chatgpt/selfrlhf2/rlhf_step1_llama2_7b_t1/epoch-2
CRITIC_MODEL_PATH=/tmp/home/sist/teslazhu20/model/chatgpt/selfrlhf2/rlhf_step2_llama2_7b_t1/epoch-0
ACTOR_ZERO_STAGE=2
CRITIC_ZERO_STAGE=2
OUTPUT=/home/sist/teslazhu20/model/chatgpt/selfrlhf2/rlhf_step3_llama2_7b_t1

export TORCH_EXTENSIONS_DIR=/home/sist/teslazhu20/model/usercache/pt201c117
...
POSITIONAL=()
OUTPUT=${OUTPUT}_lora${Lora_Lr}_promptlen${promptlen}_answerlen${answerlen}_loradim${loradim}_batchsize_${batchsize}
...
echo "deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 12346 main.py \
