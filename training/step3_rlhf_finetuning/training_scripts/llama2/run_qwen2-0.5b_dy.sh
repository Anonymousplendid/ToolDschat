...
ACTOR_MODEL_PATH=/aiarena/gpfs/models/qwen2-0.5b
CRITIC_MODEL_PATH=/aiarena/gpfs/models/qwen2-0.5b
ACTOR_ZERO_STAGE=2
CRITIC_ZERO_STAGE=2
OUTPUT=/aiarena/gpfs/tools/debugoutput
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 12346 main.py \
   --data_path /aiarena/gpfs/data/Dahoas/rm-static \
   --data_split 2,4,4 \
   ...
   --lora_alpha $loradim \
   --actor_lora_module_name "q_proj" \
   --critic_lora_module_name "q_proj" \
   --output_dir $OUTPUT \
   --enable_tensorboard \
